      ...
      <header className=" bg-gray-800 text-white ml-48 mr-48 rounded-b-3xl *">
           ...
           <nav className="container mx-auto p-4 pt-4">
              <ul className="flex justify-center space-x-8">
                <li><Link href="/routes/Best-Sellers" className="hover:text-orange-600 delay-200">Best Sellers</Link></li>
        ...
        <div className="flex mt-10">
           ...
           <select className="ml-52  bg-slate-800 text-white py-2 px-4 rounded-l mr-32">
        <option className="bg-slate-800 text-white ">All Category</option>
          ...
          <option value="electronics"className="bg-slate-800 text-white">long-sleeved</option>
